...
#   puts "#{Room.count} rooms were created"
  ...
  amboise = Activity.create(phone: "02 47 57 00 98",
                              ...
                              price: "13.5",
                              distance: "27km",
                              tag_list: "Culture, Loisir, Leisure"
                            )
